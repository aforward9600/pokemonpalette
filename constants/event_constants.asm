const_value = 0
	...
	const GYMLEADERS_EVENTS_START                    ; 009, (D748, bit 1)
	const EVENT_BEAT_BROCK_POST                      ; 00A, (D748, bit 1)
	const EVENT_BEAT_MISTY_POST                      ; 00B, (D748, bit 2)
	const EVENT_BEAT_LT_SURGE_POST                   ; 00C, (D748, bit 3)
	const EVENT_BEAT_ERIKA_POST                      ; 00D, (D748, bit 4)
	const EVENT_BEAT_KOGA_POST                       ; 00E, (D748, bit 5)
	const EVENT_BEAT_SABRINA_POST                    ; 00F, (D748, bit 6)
	const EVENT_BEAT_BLAINE_POST                     ; 010, (D749, bit 0)
	const EVENT_OAK_REMATCH                          ; 011, (D749, bit 1)
	const GYMLEADERS_EVENTS_END                      ; 012, (D749, bit 2)
	...
	const EVENT_GOT_SECOND_FOSSIL                    ; 17F, (D776, bit 7)
	const EVENT_GOT_TM41                             ; 180, (D777, bit 0)
	const EVENT_MT_MOON_SUPER_NERD                   ; 181, (D777, bit 1)
