MtMoon3Object:
	...
	object SPRITE_ROCKET_F, 29, 11, STAY, UP, 4, OPP_ROCKET_F, 1
	object SPRITE_ROCKET_F, 29, 17, STAY, LEFT, 5, OPP_ROCKET_F, 2
	object SPRITE_SHELL, 12, 6, STAY, NONE, 6 ; person
	object SPRITE_SHELL, 13, 6, STAY, NONE, 7 ; person
