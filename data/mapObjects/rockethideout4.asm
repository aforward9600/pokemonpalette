RocketHideout4Object:
	...
	db 9 ; objects
	object SPRITE_GIOVANNI, 25, 3, STAY, DOWN, 1, OPP_BOSS_GIOVANNI, 1
	object SPRITE_ARCHER, 23, 12, STAY, DOWN, 2, OPP_ARCHER, 1
	object SPRITE_ARIANA, 26, 12, STAY, DOWN, 3, OPP_ARIANA, 1
	object SPRITE_ROCKET_F, 11, 2, STAY, DOWN, 4, OPP_ROCKET_F, 8
