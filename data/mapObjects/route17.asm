Route17Object:
	...
	db 10 ; objects
	object SPRITE_CUEBALL, 12, 19, STAY, LEFT, 1, OPP_CUE_BALL, 4
	object SPRITE_CUEBALL, 11, 16, STAY, RIGHT, 2, OPP_CUE_BALL, 5
	...
	object SPRITE_CUEBALL, 17, 58, STAY, LEFT, 6, OPP_CUE_BALL, 6
	object SPRITE_CUEBALL, 2, 68, STAY, RIGHT, 7, OPP_CUE_BALL, 7
	object SPRITE_CUEBALL, 14, 98, STAY, RIGHT, 8, OPP_CUE_BALL, 8
