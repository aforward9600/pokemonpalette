Route16Object:
	...
	object SPRITE_CUEBALL, 14, 13, STAY, RIGHT, 2, OPP_CUE_BALL, 1
	object SPRITE_CUEBALL, 11, 12, STAY, UP, 3, OPP_CUE_BALL, 2
	object SPRITE_BIKER, 9, 11, STAY, LEFT, 4, OPP_BIKER, 6
	object SPRITE_CUEBALL, 6, 10, STAY, RIGHT, 5, OPP_CUE_BALL, 3
