SilphCo5Object:
	...
	object SPRITE_ROCKET, 8, 16, STAY, RIGHT, 2, OPP_ROCKET, 27
	object SPRITE_OAK_AIDE, 8, 3, STAY, RIGHT, 3, OPP_SCIENTIST, 5
	object SPRITE_ROCKER, 18, 10, STAY, UP, 4, OPP_JUGGLER, 1
	object SPRITE_ROCKET_F, 28, 4, STAY, UP, 5, OPP_ROCKET_F, 13
