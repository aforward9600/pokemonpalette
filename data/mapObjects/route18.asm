Route18Object:
	...
	db 3 ; objects
	object SPRITE_ROCKER, 36, 11, STAY, RIGHT, 1, OPP_BIRD_KEEPER, 8
	object SPRITE_ROCKER, 40, 15, STAY, LEFT, 2, OPP_BIRD_KEEPER, 9
	object SPRITE_ROCKER, 42, 13, STAY, LEFT, 3, OPP_BIRD_KEEPER, 10
