CeruleanCityObject:
	...
	warp 19, 25, 0, CERULEAN_CITY_OLD_ROD_HOUSE
	...
	object SPRITE_ROCKET_F, 30, 8, STAY, NONE, 2, OPP_ROCKET_F, 3
	...
	warp_to 19, 25, CERULEAN_CITY_WIDTH ; CERULEAN_CITY_OLD_ROD_HOUSE
