Route19Object:
	...
	object SPRITE_SWIMMER, 8, 43, STAY, LEFT, 7, OPP_SWIMMER_F, 4
	object SPRITE_SWIMMER, 11, 43, STAY, RIGHT, 8, OPP_SWIMMER_F, 5
	object SPRITE_SWIMMER, 9, 42, STAY, UP, 9, OPP_SWIMMER, 8
	object SPRITE_SWIMMER, 10, 44, STAY, DOWN, 10, OPP_SWIMMER_F, 6
